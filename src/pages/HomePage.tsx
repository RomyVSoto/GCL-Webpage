  ...
  return (
    <main className="container mx-auto px-6 py-10 max-w-10xl mb-8" id="home">
      <div className="bg-gray-50 min-h-screen py-12 px-12 rounded-2xl shadow-2xl">
        <img src={logo_wname} alt="GCL" className="h-40 mx-auto mb-16 mt-20" />
        ...
        <div className="flex flex-wrap justify-center max-w-4xl mx-auto mt-32 gap-10">
          <img src={osha_logo} className="h-16 w-32 md:w-40 mx-auto" alt="OSHA" />
          <img src={swac_logo} className="h-16 w-32 md:w-40 mx-auto" alt="SWAC" />
          <img src={sti_logo} className="h-16 w-32 md:w-40 mx-auto" alt="STI" />
        </div>

        <div className="flex flex-col justify-center items-center max-w-lg mx-auto text-center mt-16 gap-10">
          <div className="text-center">
            ...
            <div className="flex flex-col justify-center items-center mx-auto text-center gap-16 mt-24">
              <div className="relative group w-full md:w-[40rem] hover:shadow-2xl transition-shadow duration-300 rounded-lg">
                <img src={grid_image_1} className="w-full h-80 mx-auto rounded-lg"/>
                <p className="absolute bottom-0 left-0 right-0 py-2 rounded-b-lg bg-gray-50 text-gray-800 text-center font-bold opacity-100 md:opacity-0 group-hover:opacity-85 transition-opacity duration-700">
                  {language === 'es' ? 'Instalación y reemplazo de cables' : 'Cable Placement and Replacement'}
                </p>
              </div>
              <div className="relative group w-full md:w-[40rem] mt-4 md:mt-0 hover:shadow-2xl transition-shadow duration-300 rounded-lg">
                <img src={grid_image_2} className="w-full h-80 mx-auto rounded-lg"/>
                <p className="absolute bottom-0 left-0 right-0 py-2 rounded-b-lg bg-gray-50 text-gray-800 text-center font-bold opacity-100 md:opacity-0 group-hover:opacity-85 transition-opacity duration-700">
                  {language === 'es' ? 'Instalación de cámaras de seguridad' : 'Security Camera Installation'}
                </p>
              </div>
              <div className="relative group w-full md:w-[40rem] mt-4 md:mt-0 hover:shadow-2xl transition-shadow duration-300 rounded-lg">
                <img src={grid_image_3} className="w-full h-80 mx-auto rounded-lg"/>
                <p className="absolute bottom-0 left-0 right-0 py-2 rounded-b-lg bg-gray-50 text-gray-800 text-center font-bold opacity-100 md:opacity-0 group-hover:opacity-85 transition-opacity duration-700">
                  {language === 'es' ? 'Diseño y construcción' : 'Design Build'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-5 py-12 mt-16">
          <div className="text-center">
            <h1 className="text-xl font-bold mb-12 text-center text-gray-800">
              {language === 'es' ? 'Mientras instalamos cableado, nos adherimos a estos códigos y estándares:' : 'While installing cabling, we adhere to these codes and standards:'}
            </h1>
          </div>
